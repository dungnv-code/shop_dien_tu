...
import { getAllBlog, getBlogCategorisAll, CreateBlogCategoris, DeleteBlogUser, UpdateBlogUser, UpdateStatusBlog } from "../../../api/Blog";
...
const ManagerBlog = () => {
    ...
    const hanleUpdateStatus = async (id, status) => {
        const reponse = await UpdateStatusBlog(id, status)
        if (reponse?.success) {
            Swal.fire({
                icon: 'success',
        ...
        <div className="p-4">
            ...
            </div>
            {
                iscreate ? (<>
                    ...
                    (<>   <h2 className="fw-bold mb-3 text-center">📚 Quản lí bài viết</h2>
                        <hr />
                                    ...
                                    {blogs?.length > 0 ? (
                                        blogs.map((item, index) => (
                                            <tr key={item._id || index}>
                                                ...
                                                <td className="text-start">{item?.author?.name}</td>
                                                ...
                                                <td>
                                                    ...
                                                    <button className="btn btn-sm btn-outline-primary m-1" onClick={() => { hanleUpdateStatus(item._id, { status: "Đã duyệt" }) }} >
                                                        Duyệt bài
                                                    </button>
                                                    <button className="btn btn-sm btn-outline-warning m-1" onClick={() => { hanleUpdateStatus(item._id, { status: "Chờ xét duyệt" }) }} >
                                                        Chờ xét duyệt
                                                    </button>
                                                </td>
                                            </tr>
